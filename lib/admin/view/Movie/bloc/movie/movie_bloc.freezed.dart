...
abstract class _GetMovies implements MovieEvent {
...
class _$LoadedImpl implements _Loaded {
  const _$LoadedImpl(final List<Movie> data) : _data = data;
...
abstract class _Loaded implements MovieState {
  const factory _Loaded(final List<Movie> data) = _$LoadedImpl;
